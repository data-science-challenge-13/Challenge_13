...
The islands are a virtual simulation made by the University of Queensland.  The simulation allows users to interact with, conduct consentual given tests on, and collect data on the individuals living on the island.
